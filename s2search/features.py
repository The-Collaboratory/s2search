...
'''
Putting these in the global namespace so I can easily do
python multiprocessing Pool mapping for LM scoring.
This is obviously not ideal but this code is spaghetti
and this is the easiest way to speed it up. Will look into
cleaning this up if it becomes a priority.
'''
...
glms = (lm_title_abstracts, lm_authors, lm_venues)
...
def make_features(query, result_paper, max_q_len=128, max_field_len=1024): # originally accepts lms as third arg
    # the language model should have the beginning and end of sentences turned off
    lm_tiab, lm_auth, lm_venu = glms # originally lms
    lm_dict = {
